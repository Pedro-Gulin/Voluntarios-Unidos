...
def create_db(app: Flask):
    with app.app_context():
        ...
        primeira_vez = Role.query.first() is None

        if primeira_vez:
            print(">>> DETECTADO: Primeira vez rodando. "
            ...
            Areas.salvar_area("Cozinha", 8, "Ajuda no preparo")
            Areas.salvar_area("Recepção", 6, "Atendimento inicial")
            Areas.salvar_area("Limpeza", 10, "Higienização")
            ...
            # ---- ATUACAO ----
            Atuacao.salvar_atuacao(1, 1, 12, 12.50, "Cozinha", 
                                   "2025-10-23", "2025-10-25")
            Atuacao.salvar_atuacao(2, 2, 10, 11.00, "Recepção", 
                                   "2025-10-10", "2025-10-15")
            Atuacao.salvar_atuacao(3, 3, 8, 10.00, "Manutenção", 
                                   "2025-10-05", "2025-10-09")
            Atuacao.salvar_atuacao(4, 4, 9, 9.50, "Limpeza", 
                                   "2025-10-03", "2025-10-15")

            # ---- ESCALA ----
            Escala.salvar_escala(1, "Pedro da Silva", 1, "Maqueiro", 
                                 "2025-10-04", "Manhã", "ativo")
            Escala.salvar_escala(2, "Ana Paula Souza", 2, "Cozinha", 
                                 "2025-10-05", "Tarde", "ativo")
            Escala.salvar_escala(3, "João Pereira", 3, "Recepção", 
                                 "2025-10-06", "Noite", "ativo")
            Escala.salvar_escala(4, "Maria Oliveira", 4, "Limpeza", 
                                 "2025-10-07", "Manhã", "ativo")

            # ---- HABILIDADES ----
            Habilidades.salvar_habilidade("Cozinhar", "Cozinhar bem")
            Habilidades.salvar_habilidade("Comunicação", "Boa comunicação")
            Habilidades.salvar_habilidade("Manutenção", "Pequenos reparos")
            Habilidades.salvar_habilidade("Organização", "Organizado")

            # ---- HABILIDADE_VOLUNTARIO ----
            Habilidade_voluntario.save_habilidade_voluntario(
                1, 1, "Pedro da Silva", "Cozinhar")
            Habilidade_voluntario.save_habilidade_voluntario(
                2, 2, "Ana Paula Souza", "Comunicação")
            Habilidade_voluntario.save_habilidade_voluntario(
                3, 3, "João Pereira", "Manutenção")
            Habilidade_voluntario.save_habilidade_voluntARIO(
                4, 4, "Maria Oliveira", "Organização")

            # ---- NUCLEO_VOLUNTARIADO ----
            nucleo_voluntariado.save_nucleo_voluntario(
                1, "Pedro da Silva", "07:00 - 12:00", "00:00 - 00:00", 
                "07:00 - 14:00", "00:00 - 00:00", "10:00 - 18:00", 
                "00:00 - 00:00", "07:00 - 19:00")
            nucleo_voluntariado.save_nucleo_voluntario(
                2, "Ana Paula Souza", "00:00 - 00:00", "08:00 - 14:00", 
                "00:00 - 00:00", "10:00 - 16:00", "00:00 - 00:00", 
                "09:00 - 13:00", "00:00 - 00:00")
            nucleo_voluntariado.save_nucleo_voluntario(
                3, "João Pereira", "00:00 - 00:00", "09:00 - 12:00", 
                "08:00 - 15:00", "00:00 - 00:00", "10:00 - 14:00", 
                "00:00 - 00:00", "00:00 - 00:00")
            nucleo_voluntariado.save_nucleo_voluntario(
                4, "Maria Oliveira", "08:00 - 12:00", "00:00 - 00:00", 
                "00:00 - 00:00", "09:00 - 15:00", "00:00 - 00:00", 
                "07:00 - 13:00", "00:00 - 00:00")
            ...
            print(">>> SUCESSO: Banco de dados populado com dados iniciais.")
        
        else:
            print(">>> DETECTADO: O banco de dados ja existe. "
                  "Ignorando populacao de dados.")